...
export function Leaderboard({
  ...
  currentUserId,
  title = "Leaderboard",
  emptyMessage = "Add friends or a group to see the leaderboard.",
}: LeaderboardProps) {
  ...
  const hasRivals = sorted.some((u) => u.user.id !== currentUserId);
  ...
  return (
    <Card variant="glass">
      ...
      {!hasRivals ? (
        <CompeteEmptyCta compact message={emptyMessage} />
      ) : (
        <>
